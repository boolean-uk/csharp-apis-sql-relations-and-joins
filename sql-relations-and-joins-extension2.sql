...
INSERT INTO Film_Cast (FilmFK, PeopleFK)
VALUES
(1,10),
(1,23),
(1,6),
...
SELECT Film.Title, People.Name, Roles.Role FROM Film_Cast
INNER JOIN People ON PeopleFK = people.id
INNER JOIN Roles ON RoleFK = roles.id
INNER JOIN Film ON FilmFK = film.id
